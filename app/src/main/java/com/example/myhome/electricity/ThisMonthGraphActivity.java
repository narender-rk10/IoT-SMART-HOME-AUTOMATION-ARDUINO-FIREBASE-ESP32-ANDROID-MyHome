...
public class ThisMonthGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_this_month_graph);

        chart = (BarChart) findViewById(R.id.chartThisMonth);
